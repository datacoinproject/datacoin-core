...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s datacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  datacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded datacoin transaction") + "\n" +
              "  datacoin-tx [options] -create [commands]   " + _("Create hex-encoded datacoin transaction") + "\n" +
              "\n";
