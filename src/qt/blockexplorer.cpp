...
{
    QString CSS = "body {font-size:12px; background-color: #8fae70; color:#444;}\n a, span { font-family: monospace; }\n span.addr {color:#13BE5D; font-weight: bold;}\n table tr td {padding: 3px; border: none; background-color: #8fae70;}\n td.d0 {font-weight: bold; color:#f8f8f8;}\n h2, h3 { white-space:nowrap; color:#8fae70;}\n a { text-decoration:none; }\n a.nav {color:green;}\n";
