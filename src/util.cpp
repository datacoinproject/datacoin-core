...
const char * const BITCOIN_PID_FILENAME = "datacoind.pid";
bool fTestNet = false;
bool fDebug = false;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Datacoin";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Datacoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Datacoin Core developers";
    }
